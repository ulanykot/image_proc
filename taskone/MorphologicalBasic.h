...
#pragma endregion
    ...
    static void MorphologicalBasic::hitOrMiss(cimg_library::CImg<unsigned char> &image, const std::array<std::array<int, 3>, 3> &se);
    ...
    static void doHMT(cimg_library::CImg<unsigned char> &image, int se);
};
